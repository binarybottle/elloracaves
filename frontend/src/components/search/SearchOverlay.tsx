    ...
    <div className="fixed inset-0 bg-black/90 backdrop-blur-sm z-50 flex items-start justify-center p-4 overflow-y-auto">
      <div className="w-full max-w-5xl bg-black border-2 border-gray-700 rounded-lg shadow-2xl mt-8 mb-8">
        ...
        <div className="p-4 border-b border-gray-700">
          <div className="mb-3">
            <h3 className="text-lg font-semibold text-white mb-1">Start typing to search images</h3>
            <p className="text-sm text-gray-400">Search by subject, description, motifs, or keywords</p>
          </div>
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-gray-900 text-white border-2 border-gray-700 rounded-lg pl-10 pr-10 py-3 text-base focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500"
            />
